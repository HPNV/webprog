            ...
            <div class="relative sm:max-w-3xl w-full">
                ...
                <div class="relative w-full rounded-3xl px-10 py-8 bg-white shadow-md">
                    ...
                    <form method="POST" action="{{ route('register') }}" class="mt-12">
                        ...
                        <div class="mt-8">
                            <button type="submit" class="bg-blue-600 w-full py-4 rounded-xl text-white shadow-xl hover:shadow-inner focus:outline-none transition duration-500 ease-in-out transform hover:-translate-x hover:scale-105">
                                Register
                            </button>
                        </div>
                        ...
                        <div class="mt-8">
                            <div class="flex justify-center items-center">
                                <label class="mr-2 text-blue-600">Already have an account?</label>
                                <a href="/login" class="text-blue-700 transition duration-500 ease-in-out transform hover:-translate-x hover:scale-105">
                                    Login here
                                </a>
                            </div>
                        </div>
